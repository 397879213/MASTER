...
public class SqlDocument extends DefaultStyledDocument {
    ...
    public SqlDocument() {
        ...
        StyleConstants.setForeground(normal, new Color(0, 0, 140));
        //***************************
        ...
        keywords.put("DISTINCT", dummyObject);
        keywords.put("ORDER BY", dummyObject);
        keywords.put("GROUP BY", dummyObject);
    ...
    private int getOtherToken(String content, int startOffset, int endOffset) {
        ...
        if (isKeyword(token)){
            //JOptionPane.showMessageDialog(null, token + " is keyword");
