...
public class JTextFormatting extends DefaultStyledDocument {
    ...
    public JTextFormatting() {
        ...
        StyleConstants.setForeground(normal, Color.darkGray);
        ...
        keywords.put("PATIENT", dummyObject);
        keywords.put("ID", dummyObject);
        keywords.put("NAME", dummyObject);
        keywords.put("AGE", dummyObject);
        keywords.put("GENDER", dummyObject);
        keywords.put("RESULT", dummyObject);
        keywords.put("CONCLUSION", dummyObject);
