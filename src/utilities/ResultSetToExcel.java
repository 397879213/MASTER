    ...
    private void writeCell(HSSFRow row, int col, Object value, FormatType formatType, Short bgColor, HSSFFont font)
        ...
        switch (formatType) {
            ...
            case INTEGER:
                ...
                HSSFCellUtil.setCellStyleProperty(cell, workbook, Formats.DATA_FORMAT, HSSFDataFormat
                        .getBuiltinFormat(("#,##0")));
                break;
            case FLOAT:
            ...
            case MONEY:
                cell.setCellValue(((Number) value).intValue());
                HSSFCellUtil.setCellStyleProperty(cell, workbook, Formats.DATA_FORMAT, format
                        .getFormat("($#,##0.00);($#,##0.00)"));
                break;
            case PERCENTAGE:
                cell.setCellValue(((Number) value).doubleValue());
        ...
        if (bgColor != null) {
            HSSFCellUtil.setCellStyleProperty(cell, workbook, Formats.FILL_FOREGROUND_COLOR, bgColor);
            HSSFCellUtil
                    .setCellStyleProperty(cell, workbook, Formats.FILL_PATTERN, HSSFCellStyle.SOLID_FOREGROUND);
        }
    }
