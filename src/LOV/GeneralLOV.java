...
import TableModel.LOVTableModel;
...
public class GeneralLOV extends javax.swing.JDialog {

    private TableRowSorter<LOVTableModel> sorter;
    LOVTableModel model;
    public int search = 1;
    public GeneralLOV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setLov(Vector values) {
        ...
        model = new LOVTableModel(values);
     
        tableLOV.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        sorter = new TableRowSorter<LOVTableModel>(model);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                GeneralLOV dialog = new GeneralLOV(new javax.swing.JFrame(), true);
    ...
    private void newFilter() {
        RowFilter<LOVTableModel, Object> rf = null;
