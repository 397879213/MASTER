...
public class RegisteredMachineTableModel extends AbstractTableModel {

    private final String[] columnNames
            = {"Sr.", "Machine", "Type", "IP", "PORT"};
    private final Object[][] data;

    public RegisteredMachineTableModel(List<ModalityAnalyzer> listQuestions) {
        ...
        for (ModalityAnalyzer patientQuestions : listQuestions) {
            ...
            data[row][2] = currentInfo.getMachineType();
            data[row][3] = currentInfo.getIp();
            data[row][4] = currentInfo.getPort();
            row++;
        }
    }
