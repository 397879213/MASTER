 ...
 * @author adnan
 */
public class cptDischargeTableModel extends AbstractTableModel {

    private final String[] columnNames = {"AD.NO", "DESCRIPTION","TYPE","CLINICAL QUERIES"};

    private final Object[][] data;

    public cptDischargeTableModel(List<DischargePatientDetail> cps) {
        boolean check = false;
