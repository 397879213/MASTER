...
public class ApprovedRefundTableModel extends AbstractTableModel {

    private final String[] columnNames
            = {"Sr", "Patient Id", "Name", "Amount",
                "Action By", "Action Date", "Status"};

    private final Object[][] data;

    public ApprovedRefundTableModel(List<InpatientRefund> liInfo) {
        ...
        for (InpatientRefund obj : liInfo) {
            ...
            data[row][4] = currentinfo.getActionName();
            data[row][5] = currentinfo.getActionDate();
            data[row][6] = currentinfo.getStatusDescription();
