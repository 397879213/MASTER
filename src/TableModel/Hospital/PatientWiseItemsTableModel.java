...
public class PatientWiseItemsTableModel extends AbstractTableModel {

    String[] columnNames = { "DESCRIPTION","UNIT PRICE","QTY","PAYABLE"};
    private Object[][] data;

    public PatientWiseItemsTableModel(List orders) {
