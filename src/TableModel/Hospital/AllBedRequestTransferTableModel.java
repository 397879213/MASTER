...
public class AllBedRequestTransferTableModel extends AbstractTableModel {

    private final String[] columnNames
            = {"Sr.","Patient Id","From Ward","From Bed","To Ward","Crtd Date","Crtd By"};
  
    private final Object[][] data;

        public AllBedRequestTransferTableModel(List<BedTransferRequest> liInfo) {
        ...
        data[row][6]=currentinfo.getCrtdBy();
