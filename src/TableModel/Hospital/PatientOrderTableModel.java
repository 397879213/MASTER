...
public class PatientOrderTableModel extends AbstractTableModel {

    private String[] columnNames = {"Sr", "Item Name", "Status", "Prescribed By", "Prescribed Date"};

    private Object[][] data;

    public PatientOrderTableModel(List lovs) {
        ...
        for (int i = 0; i < lovs.size(); i++) {
            ...
            data[i][3] = pharmacyOrder.getStartBy();
            data[i][4] = pharmacyOrder.getStartDate();
        }
    }
