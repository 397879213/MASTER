 ...
 * @author sibtain
 */
public class OutsideInvestigationsTableModel extends AbstractTableModel {

    private final String[] columnNames = { "Test","Perform Date","Health Facility"};

    private final Object[][] data;

    public OutsideInvestigationsTableModel(List<OutsideInvestigation> li) {
