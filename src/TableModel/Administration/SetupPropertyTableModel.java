 ...
 * @author sibtain
 */
public class SetupPropertyTableModel extends AbstractTableModel {

    private final String[] columnNames = 
                {"Sr.", "Id", "Property", "Active"};

    private Object[][] data;

    public SetupPropertyTableModel(List<SetupTableColumnBO> li) {
