...
public class ReportConfigurationTableModel extends AbstractTableModel {
    ...
    private final String[] columnNames
            = {"Sr.","Name","Path","Status","Crtd By","Crtd Date"};
    private final Object[][] data;

    public ReportConfigurationTableModel(List<ReportConfiguration> listQuestions) {
        ...
        for (ReportConfiguration patientQuestions : listQuestions) {
            ...
            data[row][0] = i++;
            data[row][1] = currentInfo.getReportName();
            data[row][2] = currentInfo.getReportPath();
            data[row][3] = currentInfo.getActive();
