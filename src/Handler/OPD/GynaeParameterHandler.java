...
public class GynaeParameterHandler {
    ...
    public List<GynaeParameter> selectGayneeParameter(String patientId,
        ...
        String colums[] = {"-", "PATIENT_ID", "REFERENCE_ID", "LMP", "EDD",
            "FETUS", "FCA", "HEAD_CIRCUMFERENCE", "AC", "LIE", "PRESENTATION",
        ...
        String query = " SELECT GP.PATIENT_ID,                               \n"
                ...
                + Database.DCMS.gynaeParameters + "  GP,                     \n"
