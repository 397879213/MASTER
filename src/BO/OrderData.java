...
public class OrderData implements java.io.Serializable {
    ...
    private float newBalanceAmount = 0;
    private float refundAmountAdjustment = 0;
    private float refundTotalDiscount = 0;
    private float ledgerBalanceAmount = 0;
    private float ledgerAdjustedAmount = 0;
    ...
    private String cptReportingType = "";
    private float cashRefund = 0;
    private float invoiceBalanceAdjusted = 0;
    private String netPayableAmount = "0";
    private String payableAmount = "0";
    private float refundCPTsBalanceAmount = 0;
    ...
    public String getCptReportingType() {
        return cptReportingType;
    }

    public void setCptReportingType(String cptReportingType) {
        this.cptReportingType = cptReportingType;
    }
    ...
    public float getRefundCPTsBalanceAmount() {
        return refundCPTsBalanceAmount;
    }

    public void setRefundCPTsBalanceAmount(float refundCPTsBalanceAmount) {
    ...
    public void setFinancialSupport(float financialSupport) {
        this.financialSupport = financialSupport;
    }

    public float getTotalFinancialSupport() {
        return totalFinancialSupport;
    }

    public void setTotalFinancialSupport(float totalFinancialSupport) {
    ...
    public void setNewBalanceAmount(float newBalanceAmount) {
        this.newBalanceAmount = newBalanceAmount;
    }

    public float getRefundAmountAdjustment() {
        return refundAmountAdjustment;
    }

    public void setRefundAmountAdjustment(float refundAmountAdjustment) {
        this.refundAmountAdjustment = refundAmountAdjustment;
    }

    public float getLedgerBalanceAmount() {
        return ledgerBalanceAmount;
    }

    public float getLedgerAdjustedAmount() {
        return ledgerAdjustedAmount;
    }

    public void setLedgerAdjustedAmount(float ledgerAdjustedAmount) {
        this.ledgerAdjustedAmount = ledgerAdjustedAmount;
    }

    public void setLedgerBalanceAmount(float ledgerBalanceAmount) {
    ...
    public float getRefundTotalDiscount() {
        return refundTotalDiscount;
    }

    public void setRefundTotalDiscount(float refundTotalDiscount) {
    ...
    public float getInvoiceBalanceAdjusted() {
        return invoiceBalanceAdjusted;
    }

    public void setInvoiceBalanceAdjusted(float invoiceBalanceAdjusted) {
    ...
    public String getCptOrderTime() {
        return cptOrderTime;
    }

    public void setCptOrderTime(String cptOrderTime) {
        this.cptOrderTime = cptOrderTime;
    }
