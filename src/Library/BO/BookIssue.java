...
public class BookIssue implements java.io.Serializable {
    ...
    public String bookLimitDays = "";
    public String bookIssuanceId = "";
    public String returnDate = "";
    public String crtdBy = "";
    public String crtdDate = "";
    public String crtdTerminalId = "";
    public String authorName = "";
    public String bookCollectBy = "";
    
    
    

    public BookIssue(String bookId, String bookName, String subject, 
            String edition, String author, String member) {
    ...
    public String getBookCollectBy() {
        return bookCollectBy;
    }

    public void setBookCollectBy(String bookCollectBy) {
        this.bookCollectBy = bookCollectBy;
    }
    ...
    public void setBookLimitDays(String bookLimitDays) {
        this.bookLimitDays = bookLimitDays;
    }

    public String getBookIssuanceId() {
        return bookIssuanceId;
    }

    public void setBookIssuanceId(String bookIssuanceId) {
