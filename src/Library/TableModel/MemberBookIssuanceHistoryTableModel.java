...
public class MemberBookIssuanceHistoryTableModel extends AbstractTableModel {
    ...
    public MemberBookIssuanceHistoryTableModel(List<BookIssue> LstBook) {
        ...
        for (int i = 0; i < LstBook.size(); i++) {
            ...
            data[row][4] = bookIss.getReturnDate();
            data[row][5] = bookIss.getBookCollectBy();
            row++;
        }
    }
