...
public class MemberRecentIssuedTableModel extends AbstractTableModel {

    private final String[] columnNames
            = {"Sr.", "Book Name", "Status Id","Issue Date", "Issued By"};
    private final Object[][] data;

    public MemberRecentIssuedTableModel(List<BookIssue> LstBook) {
