...
public class SelectedParameterListTableModel extends AbstractTableModel {

    private final String[] columnNames
            = {"Sr.", "Parameter Name", "Verified Date","Result"};
    private final Object[][] data;

    public SelectedParameterListTableModel(List<PatientHospitalVisit> listParameter) {
