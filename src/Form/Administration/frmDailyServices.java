...
import Controller.Administration.CtlDailyServices;
import Form.general.*;
import TableModel.Administration.CptWisePatInfoTableModel;
import TableModel.Administration.DeptWiseSectionsTableModel;
import TableModel.Administration.LocWiseDeptTableModel;
import TableModel.Administration.SectionsWiseServicesTableModel;
...
public class frmDailyServices extends javax.swing.JInternalFrame {

    public frmDailyServices() {

        initComponents();
        this.setSize(Constants.xSize - 70, Constants.ySize - Constants.yExtension + 30);

    }
    
    //Objets.
    DisplayLOV lov = new DisplayLOV();
    CtlDailyServices ctlObj = new CtlDailyServices();
    ...
    //List Initialization.
    private List<BODailyServices> lstLocWiseDept = new ArrayList();
    private List<BODailyServices> lstDeptWiseSectios = new ArrayList();
    private List<BODailyServices> lstSecWiseCpt = new ArrayList();
    private List<BODailyServices> lstPatInfo = new ArrayList();
    ...
    private void tbServicesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbServicesMouseReleased
        ...
        int selectedIndex;
        selectedIndex = tbServices.getSelectedRow();
        objBO = lstDeptWiseSectios.get(selectedIndex);
        
        secId = objBO.getSectionId();
        secDesc = objBO.getSectionName();
    ...
    private void tblDeptMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDeptMouseReleased
        ...
        int selectedRow;
        selectedRow = tblDept.getSelectedRow();
        objBO = lstLocWiseDept.get(selectedRow);
        
        deptId = objBO.getDepartmentId();
        deptDesc = objBO.getDepartmentName();
    ...
    private void tblCPTWiseServicesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCPTWiseServicesMouseReleased
        ...
        int selectedRow;
        selectedRow = tblCPTWiseServices.getSelectedRow();
        
        objBO = lstSecWiseCpt.get(selectedRow);
        cptId = objBO.getCptId();
        cptDesc = objBO.getCptName();
    ...
    private void txtLocationServicesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtLocationServicesActionPerformed
        ...
        lstLocWiseDept = ctlObj.locWiseDept(locId);
        setInDeptTable();
    ...
    private void setInSectionTbl() {
        ...
        lstDeptWiseSectios = ctlObj.deptWiseSec(deptId);
    ...
    private void setInCptCountTbl() {
        ...
        lstSecWiseCpt = ctlObj.sectionWiseServices(secId, fromDate, toDate);
    ...
    private void setInPatInfoTbl() {
        ...
        lstPatInfo = ctlObj.cptWisePatInfo(cptId, fromDate, toDate);
