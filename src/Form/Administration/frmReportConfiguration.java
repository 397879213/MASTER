...
//import BO.Administration.ModalityAnalyzer;
import BO.Administration.ReportConfiguration;
//import TableModel.RegisteredMachineTableModel;
//import Controller.Administration.MachineController;
import Controller.Administration.ReportConfigurationController;
import Controller.PatientController;
import TableModel.Administration.ReportConfigurationTableModel;
import TableModel.Administration.ReportWiseParameterTableModel;
//import TableModel.SectionWiseMachineTableModel;
...
public class frmReportConfiguration extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnlUserDetailLayout.setHorizontalGroup(
            ...
            .addGroup(pnlUserDetailLayout.createSequentialGroup()
                ...
                .addGroup(pnlUserDetailLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtReportName, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        btnSaveReport.setForeground(new java.awt.Color(153, 0, 51));
        ...
        btnEditReport.setForeground(new java.awt.Color(153, 0, 51));
        ...
        btnClearReport.setForeground(new java.awt.Color(153, 0, 51));
        ...
        pnlUserDetail1Layout.setHorizontalGroup(
            ...
            .addGroup(pnlUserDetail1Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(txtSearchReport, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                .addComponent(txtSearchReportPath)
                .addContainerGap())
        );
        ...
        btnAttachReport.setForeground(new java.awt.Color(153, 0, 51));
        ...
        btnDeleteReport.setForeground(new java.awt.Color(153, 0, 51));
        ...
        pnlSearchUser3Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane10, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 536, Short.MAX_VALUE)
        );
    ...
    private void txtReportPathActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtReportPathActionPerformed
        ...
        String query = "  SELECT ID ID, DESCRIPTION \n"
                ...
                + " WHERE DEF_TYPE_ID = 24                               \n"
                + " AND UPPER(DESCRIPTION) LIKE UPPER('%"
                + txtReportPath.getText().trim() + "%')";
        ...
        if (Constants.lovDescription.equalsIgnoreCase("DESCRIPTION")) {
            ...
            reportPathId = Constants.lovDescription;
            txtReportPath.setText(Constants.lovDescription.toUpperCase());
    ...
    private void txtSearchReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchReportActionPerformed
        ...
        if (Constants.lovDescription.equalsIgnoreCase("DESCRIPTION")) {
            ...
            searchReportId = Constants.lovID;
            txtSearchReport.setText(Constants.lovDescription.toUpperCase());
            selectReport();
        }
    ...
    private void txtSearchReportPathActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchReportPathActionPerformed
        ...
        if (Constants.lovDescription.equalsIgnoreCase("DESCRIPTION")) {
            txtSearchReportPath.setText("");
            searchPathId = "";

        } else {
            searchPathId = Constants.lovDescription;
            txtSearchReportPath.setText(Constants.lovDescription.toUpperCase());
            selectReport();
        }
    ...
    private void txtReportConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtReportConfigActionPerformed
        ...
        String query = "  SELECT ID ID, DESCRIPTION \n"
                ...
                + " AND UPPER(DESCRIPTION) LIKE UPPER('%"
                + txtReportConfig.getText().trim() + "%')";

        lov.LOVSelection(query, this);

        if (Constants.lovDescription.equalsIgnoreCase("DESCRIPTION")) {
            txtReportConfig.setText("");
            departmentId = "";

        } else {
            departmentId = Constants.lovID;
            txtReportConfig.setText(Constants.lovDescription.toUpperCase());
    ...
    private void tblAttachedReportsMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAttachedReportsMouseReleased
        ...
        txtReportName.setText(current.getReportName());
        txtReportPath.setText(current.getReportPath());
        txtReportConfig.setText(current.getReportConfig());
    ...
    private void btnSaveReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveReportActionPerformed
        ...
        if (cboActive.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null, "Kindly Choose Active Option");
        ...
        current.setReportName(txtReportName.getText().trim());
        current.setReportPath(reportPathId);
        current.setReportServer("\\\\10.10.14.10\\RISPACS\\SYSREP\\REPORTS");
        current.setReportConfig(txtReportConfig.getText().trim());
    ...
    private void btnEditReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditReportActionPerformed
        ...
        current.setReportConfig(current.getReportConfig());
        current.setActive(cboActive.getSelectedItem().toString());
    ...
    private void btnAttachReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttachReportActionPerformed
        ...
        if (reportId.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Kindly Select Report Again");
            txtReportNameId.requestFocus();
            return;
        }
        if (paramterId.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Kindly Select Parameter Again");
            txtParamterId.requestFocus();
            return;
        }
        ...
        if (ctlRep.insertReportWiseParameter(current)) {
            JOptionPane.showMessageDialog(null, "Parameter Attached Successfully");
    ...
    private void selectReport() {
        ...
        listRep = ctlRep.selectReport(searchReportId, searchPathId);
