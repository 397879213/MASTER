...
public class PatientReportStatus extends javax.swing.JInternalFrame {
    ...
    public PatientReportStatus(OPDConsultancy opd) {
    ...
    public PatientReportStatus() {
        init();
    }

    public PatientReportStatus(String patientId) {
        Constants.completePatientId = patientId;
        init();
    }

    public PatientReportStatus(PatientAdmission patientId) {
        //Constants.completePatientId = patientId;
        init();
    }
    
    public PatientReportStatus(String patientId, String a , String b) {
        //Constants.completePatientId = patientId;
        init();
    }
