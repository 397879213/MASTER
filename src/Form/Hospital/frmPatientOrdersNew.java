...
public class frmPatientOrdersNew extends javax.swing.JInternalFrame {
    ...
    public frmPatientOrdersNew(OPDConsultancy opd) {
    ...
    public frmPatientOrdersNew() {
        init();
    }

    public frmPatientOrdersNew(String patientId) {
        Constants.completePatientId = patientId;
        init();
    }

    public frmPatientOrdersNew(PatientAdmission patientId) {
        //Constants.completePatientId = patientId;
        init();
    }
